...
//        super("Команда удаляет элементы меньше чем заданный (по количеству участников). IMPORTANT: аргумент должен быть id элемента", serverCollectionManager);
//    }
//
//
//    @Override
...
//            } else {
//                if (getMusicBandCollectionManager().getMusicBandLinkedList().contains(getMusicBandCollectionManager().findModelById(Integer.parseInt(getArgs().toString())))) {
//                    int targetNumber = 0;
